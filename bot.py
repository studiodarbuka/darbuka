...
async def on_ready():
    ...
    step1_time = now.replace(hour=20, minute=50, second=0, microsecond=0)
    step2_time = now.replace(hour=20, minute=52, second=0, microsecond=0)
    step3_time = now.replace(hour=20, minute=53, second=0, microsecond=0)
